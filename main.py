...
IMPORTANT: you NEED to connected to the internet fork the database to be connected 
"""

import gspread
import time
from valid_input import list_valid_input, int_valid_input # other file
...
class library_manager():
    ...
    def add_book(self):
        ...
        # this dict allows that program to turn the 'f' and 'nf' to 'fiction' anf 'non fiction' to be writen to in the worksheet
